    ...
    const messages: Array<{ role: "system" | "user" | "assistant"; content: string }> = [
      {
        ...
        content: [
              ...
              "If a required field is missing, return kind=question and ask exactly one most important short question. Required fields in priority order: destination, departureCity, days, travelers, budgetScope. When budgetScope is all_inclusive, also require flightBudget and hotelBudget. Only ask about flight/hotel preferences (flightPreferences/hotelPreferences) after the required fields are complete, and treat 没有 as no preference.",
              ...
              "Write each description for a user who knows nothing about Korea, as a single line with parts separated by ｜ (never use newline characters): what the place is and why it matters (its uniqueness in Korea) ｜ a direct tier 推荐:必去/值得去/可去可不去/可跳过 plus who it suits (对历史感兴趣的人建议去，只想逛街的可以跳过) ｜ 门票:免费 or 约X元/人, and 注意: only when useful (如 需带护照、节假日预留更多时间). For transport or rest items write one short practical note instead (如 返回酒店取行李，建议预留 3 小时以上).",
              "Use exactly one of these two JSON shapes, with no additional top-level fields:",
              '{"kind":"question","requirements":{"destination":null,"departureCity":null,"startDate":null,"days":null,"travelers":null,"budget":null,"currency":"CNY","budgetScope":null,"flightBudget":null,"hotelBudget":null,"flightPreferences":[],"hotelPreferences":[],"interests":[],"pace":null,"constraints":[]},"question":"..."}',
              '{"kind":"plan","requirements":{"destination":"首尔","departureCity":"上海","startDate":"2026-10-01","days":2,"travelers":2,"budget":3000,"currency":"CNY","budgetScope":"all_inclusive","flightBudget":800,"hotelBudget":1200,"flightPreferences":["直飞"],"hotelPreferences":["地铁附近"],"interests":["美食"],"pace":"balanced","constraints":[]},"title":"...","summary":"...","days":[{"dayNumber":1,"date":"2026-10-01","title":"...","items":[{"time":"10:00","title":"景福宫","description":"...","estimatedCost":100,"placeQuery":"경복궁"}]}]}',
              "pace must be relaxed, balanced, packed, or null. budgetScope must be all_inclusive, activities_only, or null. Dates must be YYYY-MM-DD. Times must be HH:mm.",
